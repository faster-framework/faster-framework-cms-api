package cn.org.faster.cms.test.admin.category;
...
public class CategoryTest extends BaseTest{
    ...
    public void list() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/category");
    ...
    public void queryById() throws Exception {
        this.buildRequest(() -> MockMvcRequestBuilders.get("/category/{id}", "")).andExpect(status().is2xxSuccessful());
    }
    ...
    public void query() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/category/query");
        mockHttpServletRequestBuilder.param("id","");
        mockHttpServletRequestBuilder.param("name","");
        mockHttpServletRequestBuilder.param("code","");
        mockHttpServletRequestBuilder.param("position","");
    ...
    public void add() throws Exception {
        ...
        this.buildRequest(() -> MockMvcRequestBuilders.post("/category").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void update() throws Exception {
        ...
        request.setRemark(null);
        request.setDeleted(null);
        this.buildRequest(()-> MockMvcRequestBuilders.put("/category/{id}","").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void delete() throws Exception {
        this.buildRequest(()-> MockMvcRequestBuilders.delete("/category/{id}","")).andExpect(status().is2xxSuccessful());
    }
