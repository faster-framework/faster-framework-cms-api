package cn.org.faster.cms.test.api.v1.section;
...
import cn.org.faster.cms.api.section.model.request.SectionAddRequest;
import cn.org.faster.cms.api.section.model.request.SectionUpdateRequest;
...
public class SectionTest extends BaseTest{
    ...
    public void list() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/api/v1/section");
    ...
    public void queryById() throws Exception {
        this.buildRequest(() -> MockMvcRequestBuilders.get("/api/v1/section/{id}", "")).andExpect(status().is2xxSuccessful());
    }
    ...
    public void query() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/api/v1/section/query");
        mockHttpServletRequestBuilder.param("id","");
        mockHttpServletRequestBuilder.param("name","");
        mockHttpServletRequestBuilder.param("code","");
        mockHttpServletRequestBuilder.param("position","");
    ...
    public void add() throws Exception {
        ...
        this.buildRequest(() -> MockMvcRequestBuilders.post("/api/v1/section").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void update() throws Exception {
        ...
        request.setRemark(null);
        request.setDeleted(null);
        this.buildRequest(()-> MockMvcRequestBuilders.put("/api/v1/section/{id}","").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void delete() throws Exception {
        this.buildRequest(()-> MockMvcRequestBuilders.delete("/api/v1/section/{id}","")).andExpect(status().is2xxSuccessful());
    }
