package cn.org.faster.cms.test.admin.article;
...
public class ArticleTest extends BaseTest{
    ...
    public void list() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/article");
    ...
    public void queryById() throws Exception {
        this.buildRequest(() -> MockMvcRequestBuilders.get("/article/{id}", "")).andExpect(status().is2xxSuccessful());
    }
    ...
    public void query() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder =  MockMvcRequestBuilders.get("/article/query");
        mockHttpServletRequestBuilder.param("id","");
        mockHttpServletRequestBuilder.param("title","");
        mockHttpServletRequestBuilder.param("description","");
        mockHttpServletRequestBuilder.param("img","");
    ...
    public void add() throws Exception {
        ...
        this.buildRequest(() -> MockMvcRequestBuilders.post("/article").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void update() throws Exception {
        ...
        request.setRemark(null);
        request.setDeleted(null);
        this.buildRequest(()-> MockMvcRequestBuilders.put("/article/{id}","").content(JSON.toJSONString(request))).andExpect(status().is2xxSuccessful());
    }
    ...
    public void delete() throws Exception {
        this.buildRequest(()-> MockMvcRequestBuilders.delete("/article/{id}","")).andExpect(status().is2xxSuccessful());
    }
